...
ARG PGADMIN4_TAG="REL-3_3"
ARG APKS="python3 postgresql-client postgresql-libs libressl2.7-libssl libressl2.7-libcrypto libffi ca-certificates libintl krb5-conf libcom_err keyutils-libs libverto krb5-libs libtirpc libnsl"
...
RUN cp -a /pgadmin4/web/* /rootfs/pgadmin4/ \
